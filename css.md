...
* [picture slideshow](https://www.w3schools.com/howto/howto\_js\_slideshow.asp)
...
\*\*Dont forget \*\*all HTML elemets can be thought of as boxs. This is known and the [box model](https://www.w3schools.com/css/css\_boxmodel.asp).
